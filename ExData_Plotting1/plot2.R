...
xDateTime<-as.POSIXct(paste(powerData$Date,powerData$Time), format("%Y-%d-%Y %HH:%MM:SS"))

## Plot 1

png("plot2.png", width=480, height=480)
with(powerData, 
     plot(xDateTime,Global_active_power,  type="l", ylab="Global Active Power (kilowatts", xlab=""))
dev.off()
